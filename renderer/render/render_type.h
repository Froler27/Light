...
namespace Light
{
    ...
    struct MaterialSourceDesc
    {
        ...
        {
            return m_vertex_shader_file == rhs.m_vertex_shader_file && 
                m_fragment_shader_file == rhs.m_fragment_shader_file &&
                m_base_color_file == rhs.m_base_color_file &&
...
template<>
struct std::hash<Light::MaterialSourceDesc>
{
    size_t operator()(const Light::MaterialSourceDesc& rhs) const noexcept { return rhs.getHashValue(); }
};